...
/**
 * Created by akbar on 09/12/17.
 */

public class TopicListAdapter extends RecyclerView.Adapter<TopicListAdapter.TopicListHolder> {
    ...
    public TopicListAdapter(Context context, OnItemClickListener listener) {
        ...
        this.mDataContentItems = new ArrayList<>();
    }
    ...
    @Override
    public TopicListAdapter.TopicListHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TopicListAdapter.TopicListHolder holder, int position) {
